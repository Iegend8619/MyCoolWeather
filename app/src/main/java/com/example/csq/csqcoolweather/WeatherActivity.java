...
import com.example.csq.csqcoolweather.gson.Forecast;
import com.example.csq.csqcoolweather.gson.Weather;
import com.example.csq.csqcoolweather.service.AutoUpdateWeatherService;
    ...
    private void loadBingPic(){
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                e.printStackTrace();
                Toast.makeText(WeatherActivity.this,"由于网络原因，获取背景图片失败...(onFailure)",Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//    处理并展示weather实体类中的数据
    private void showWeatherInfo(Weather weather){
        if(weather != null && "ok".equals(weather.status)){
            ...
            Toast.makeText(WeatherActivity.this,"获取天气信息失败（后台定时器）...",Toast.LENGTH_SHORT).show();
        }
    }
}
